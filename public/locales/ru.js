(function () {
    ...
    window.__registerResonanceLocale('ru', {
        messages: {
            ...
            errLiveBackpressure: 'Онлайн-распознавание не успевает обрабатывать аудио',
            ...
            sttModeDictation: 'Диктовка',
            sttModeLive: 'Поток',
            sttMicHintIdle: 'Запишите речь с микрофона',
            sttMicHintLive: 'Говорите в микрофон — распознавание идёт в реальном времени',
            ...
            sttSysTitle: 'Системный звук',
            sttSysHintIdle: 'Захват внутреннего звука системы (встречи, видео и т.д.)',
            sttSysHintCapturing: 'Идёт захват системного звука… Нажмите «Стоп», когда закончите',
            sttSysHintProcessing: 'Обработка системного звука…',
            sttSysStart: 'Начать захват',
            sttSysIncludeMic: 'Включать микрофон',
